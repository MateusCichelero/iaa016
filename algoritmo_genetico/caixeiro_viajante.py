...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description = 'Resolução Caixeiro Viajante com Algoritmos Genéticos.')
    parser.add_argument('-n_cidades', action = 'store', dest = 'n_cidades', nargs='?', default=100, type=int,
                           help = 'Numero de cidades no mapa. Default: 100')
    parser.add_argument('-n_pop', action = 'store', dest = 'n_pop', nargs='?', default=100, type=int,
                           help = 'Numero de percursos na populacao. Default: 100')
    parser.add_argument('-tx_cruzamento', action = 'store', dest = 'tx_cruzamento', nargs='?', default=60, type=int,
                           help = 'Taxa de cruzamento. Ex: 60 para 60%. Default: 60')
    parser.add_argument('-tx_mutacao', action = 'store', dest = 'tx_mutacao', nargs='?', default=5, type=int,
                           help = 'Taxa de mutacao. Ex: 5 para 5%. Default: 5')
    parser.add_argument('-n_geracoes', action = 'store', dest = 'n_geracoes', nargs='?', default=8000, type=int,
                           help = 'Numero de geracoes para simulacao. Default: 8000')
    parser.add_argument('-n_selecao', action = 'store', dest = 'n_selecao', nargs='?', default=50, type=int,
                           help = 'Numero de individuos selecionados por ranking. Default: 50')
    

    arguments = parser.parse_args()
    main(arguments.n_cidades, arguments.n_pop, arguments.tx_cruzamento, arguments.tx_mutacao, arguments.n_geracoes, arguments.n_selecao)